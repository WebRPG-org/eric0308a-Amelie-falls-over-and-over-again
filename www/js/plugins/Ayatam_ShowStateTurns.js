...
//=============================================================================
//  【更新内容】
//  2023/3/10 v0.08 コアのターン管理を変更する機能を追加しました。
...
/*:
 * @target MV MZ
 * @plugindesc バトル中ステートターン数表示MVMZ v0.08
 ...
 * @default {"setup":"","turnsX":"0","turnsY":"0","stateFontSize":"14","changeCoreExpireingStates":"false","stateSetup":"","ignoreStates":"[]","ignoreBuffs":"[]"}
 * @desc ステートターン数表示MVMZの基本設定を行います。
 */
 ...
 *
 * @param changeCoreExpireingStates
 * @text ターン管理の変更
 * @parent setup
 * @type boolean
 * @on ターン管理を変更
 * @off デフォルトのターン管理
 * @default false
 * @desc コアのターン数計算は、ステート/バフを2ターンに指定しても実際は0ターンが含まれています。この0ターンを削除しますか？
 *
 * @param ignoreStates
...
//=============================================================================
var _ShowStateTurns_Game_BattlerBase_prototype_isStateExpired = Game_BattlerBase.prototype.isStateExpired;
Game_BattlerBase.prototype.isStateExpired = function(stateId) {
    return Ayatam.SHOWSTATETURNS.GlobalSettings.changeCoreExpireingStates ? this._stateTurns[stateId] === 1 : _ShowStateTurns_Game_BattlerBase_prototype_isStateExpired.call(this,stateId);
};

var _ShowStateTurns_Game_BattlerBase_prototype_isBuffExpired = Game_BattlerBase.prototype.isBuffExpired;
Game_BattlerBase.prototype.isBuffExpired = function(paramId) {
    return Ayatam.SHOWSTATETURNS.GlobalSettings.changeCoreExpireingStates ? this._buffTurns[paramId] === 1 : _ShowStateTurns_Game_BattlerBase_prototype_isBuffExpired.call(this,paramId);
};
