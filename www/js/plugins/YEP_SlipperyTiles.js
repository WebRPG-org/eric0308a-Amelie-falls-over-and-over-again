 ...
 */
 /*:ja
 * @plugindesc v1.05 タイルに地形タグをマークしたりリージョンナンバーを振ることで、滑るタイルを作成することができます。
 * @author Yanfly Engine Plugins
 *
 * @param Slippery Frame
 * @type number
 ...
 * @min 0
 * @max 255
 * @desc このリージョンを振られたタイルは、地形タグに関わらず、滑るタイルとなります。0を入れることで無効になります。
 * @default 0
 *
 * @param Slippery Speed
 * @type number
 * @min 0
 * @desc 滑るタイルの上でのプレーヤの移動速度を設定してください。現在の速度を維持するには0のままにします。
 * @default 0
 *
 * @help
 * 翻訳:ムノクラ
 ...
 * ============================================================================
 *
 * このプラグインを使えば、リージョンやメモタグによって、滑るタイルを設定する
