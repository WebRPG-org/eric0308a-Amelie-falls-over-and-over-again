 ...
 */
/*:ja
 * @plugindesc (v5.04 *) 戦闘のレイアウトをカスタマイズできます。
 * @author Moghunter
 *
 * @param -> MAIN <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * @param Layout2 Visible
 * @text Visible
 * @desc レイアウト2の有効設定。画像は顔とゲージの上に表示されます。
 * @default false
 * @type boolean 
 * @parent -> LAYOUT OVERLAY <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @param HP Meter Flow Anime
 * @text Gradient Animation
 * @desc HPメーターでフローアニメーションを有効設定。画像はHPメータの幅の3倍でなければなりません。
 * @default false
 * @type boolean 
 * @parent -> HP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @param MP Meter Flow Anime
 * @text Gradient Animation
 * @desc MPメーターでフローアニメーションの有効設定。画像はゲージの幅の3倍でなければなりません。
 * @default false
 * @type boolean
 * @parent -> MP <<<<<<<<<<<<<<<<<<<<<<< 
 *
 ...
 * @param TP Meter Flow Anime
 * @text Gradient Animation
 * @desc TPメーターでフローアニメーションの有効設定。画像はゲージの幅の3倍でなければなりません。
 * @default false
 * @type boolean
 * @parent -> TP <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @param ATB Meter Flow Anime
 * @text Gradient Animation
 * @desc ATBメーターでフローアニメーションの有効設定。画像はゲージの幅の3倍でなければなりません。
 * @default false
 * @type boolean
 * @parent -> ATB <<<<<<<<<<<<<<<<<<<<<<<
 *
 ...
 * @param States X-Axis
 * @text X-Axis
 * @desc ステートアイコンのX軸位置設定
 * @default 105
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param States Y-Axis
 * @text Y-Axis
 * @desc ステートアイコンのY軸位置設定
 * @default 123
 * @parent -> STATES <<<<<<<<<<<<<<<<<<<<<<< 
 *
 * @param States Mode
 * @text View Mode
 * @desc ステートアイコンの表示モード設定
 * 0 - タイミングモード / 1 - ラインモード
 * @type select
 ...
 * @param W Command X-Axis
 * @text X-Axis
 * @desc コマンドウィンドウのX軸位置設定
 * @default 0
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Command Y-Axis
 * @text Y-Axis
 * @desc コマンドウィンドウのY軸位置設定
 * @default -70
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Command Width
 ...
 * @param W Command Slide X
 * @text Slide Animation X
 * @desc コマンドウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Command Slide Y
 * @text Slide Animation Y
 * @desc コマンドウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Command
 * @text Layout (Picture)
 * @desc レイアウトコマンド画像を有効設定
 * @default true
 * @type boolean
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Command X-Axis
 * @text Layout X-Axis
 * @desc レイアウトコマンド画像のX軸位置設定
 * @default -2
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Command Y-Axis
 * @text Layout Y-Axis
 * @desc レイアウトコマンド画像のY軸位置設定
 * @default 5
 * @parent -> W COMMAND <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @param W Party X-Axis
 * @text X-Axis
 * @desc パーティウィンドウのX軸位置設定
 * @default 325
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Party Y-Axis
 * @text Y-Axis
 * @desc パーティウィンドウのY軸位置設定
 * @default 170
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Party Width
 ...
 * @param W Party Slide X
 * @text Slide Animation X
 * @desc パーティウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Party Slide Y
 * @text Slide Animation Y
 * @desc パーティウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Party
 * @text Layout (Picture)
 * @desc パーティウィンドウレイアウト画像の有効設定
 * @default true
 * @type boolean
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Party X-Axis
 * @text Layout X-Axis
 * @desc パーティウィンドウレイアウト画像のX軸位置設定
 * @default -325
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Party Y-Axis
 * @text Layout Y-Axis
 * @desc パーティウィンドウレイアウト画像のY軸位置設定
 * @default -42
 * @parent -> W PARTY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @param W Help X-Axis
 * @text X-Axis
 * @desc ヘルプウィンドウのX軸位置設定
 * @default 0
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Help Y-Axis
 * @text Y-Axis
 * @desc ヘルプウィンドウのY軸位置設定
 * @default 0
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Help Width
 ...
 * @param W Help Slide X
 * @text Slide Animation X
 * @desc ヘルプウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Help Slide Y
 * @text Slide Animation Y
 * @desc ヘルプウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Help
 * @text Layout (Picture)
 * @desc ヘルプウィンドウレイアウト画像の有効設定
 * @default true
 * @type boolean
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Help X-Axis
 * @text Layout X-Axis
 * @desc ヘルプウィンドウレイアウト画像のX軸位置設定
 * @default 0
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Help Y-Axis
 * @text Layout Y-Axis
 * @desc ヘルプウィンドウレイアウト画像のY軸位置設定
 * @default 0
 * @parent -> W HELP <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @param W Skill X-Axis
 * @text X-Axis
 * @desc スキルウィンドウのX軸位置設定
 * @default 0
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Skill Y-Axis
 * @text Y-Axis 
 * @desc スキルウィンドウのY軸位置設定
 * @default 444
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Skill Width
 ...
 * @param W Skill Slide X
 * @text Slide Animation X
 * @desc スキルウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Skill Slide Y
 * @text Slide Animation Y
 * @desc スキルウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Skill
 * @text Layout (Picture)
 * @desc スキルウィンドウレイアウト画像の有効設定
 * @default true
 * @type boolean
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Skill X-Axis
 * @text Layout X-Axis
 * @desc スキルウィンドウレイアウト画像のX軸位置設定
 * @default 0
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Skill Y-Axis
 * @text Layout Y-Axis
 * @desc スキルウィンドウレイアウト画像のY軸位置設定
 * @default -67
 * @parent -> W SKILL <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @param W Item X-Axis
 * @text X-Axis
 * @desc アイテムウィンドウのX軸位置設定
 * @default 0
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Item Y-Axis
 * @text Y-Axis
 * @desc アイテムウィンドウのY軸位置設定
 * @default 444
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Item Width
 ...
 * @param W Item Slide X
 * @text Slide Animation X 
 * @desc アイテムウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Item Slide Y
 * @text Slide Animation Y
 * @desc アイテムウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Item
 * @text Layout (Picture)
 * @desc アイテムウィンドウレイアウト画像の有効設定
 * @default true
 * @type boolean
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Item X-Axis
 * @text Layout X-Axis
 * @desc アイテムウィンドウレイアウト画像のX軸位置設定
 * @default 0
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Item Y-Axis
 * @text Layout Y-Axis
 * @desc アイテムウィンドウレイアウト画像のY軸位置設定
 * @default -67
 * @parent -> W ITEM <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @param W Actor X-Axis
 * @text X-Axis
 * @desc アクターウィンドウのX軸位置設定
 * @default 0
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Actor Y-Axis
 * @text Y-Axis
 * @desc アクターウィンドウのY軸位置設定
 * @default 444
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Actor Width
 ...
 * @param W Actor Slide X
 * @text Slide Animation X
 * @desc アクターウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Actor Slide Y
 * @text Slide Animation Y
 * @desc アクターウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Actor
 * @text Layout (Picture)
 * @desc アクターウィンドウレイアウト画像の有効設定
 * @default true
 * @type boolean
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Actor X-Axis
 * @text Layout X-Axis
 * @desc アクターウィンドウレイアウト画像のX軸位置定義
 * @default 0
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Actor Y-Axis
 * @text Layout Y-Axis
 * @desc アクターウィンドウレイアウト画像のY軸位置定義
 * @default -67
 * @parent -> W ACTOR <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
 ...
 * @param W Enemy X-Axis
 * @text X-Axis
 * @desc エネミーウィンドウのX軸位置設定
 * @default 0
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Enemy Y-Axis
 * @text Y-Axis 
 * @desc エネミーウィンドウのY軸位置設定
 * @default 444
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Enemy Width
 ...
 * @param W Enemy Slide X
 * @text Slide Animation X
 * @desc エネミーウィンドウのスライドアニメーションX軸の量
 * @default 0
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param W Enemy Slide Y
 * @text Slide Animation Y
 * @desc エネミーウィンドウのスライドアニメーションY軸の量
 * @default 0
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param Layout Enemy
 * @text Layout (Picture)
 * @desc エネミーウィンドウレイアウト画像の有効設定
 * @default true
 * @type boolean
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Enemy X-Axis
 * @text Layout X-Axis
 * @desc エネミーウィンドウレイアウト画像のX軸位置設定
 * @default 0
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param L Enemy Y-Axis
 * @text Layout Y-Axis
 * @desc エネミーウィンドウレイアウト画像のY軸位置設定
 * @default -67
 * @parent -> W ENEMY <<<<<<<<<<<<<<<<<<<<<<<
 *
 * @param
