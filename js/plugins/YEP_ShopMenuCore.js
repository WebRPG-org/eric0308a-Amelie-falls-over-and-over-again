 ...
 */
 /*:ja
 * @plugindesc v1.05 ショップメニューの外観を一新し、多くの新しいショップオプションのフレームワークを提供します。
 * @author Yanfly Engine Plugins
 *
 * @param ---一般---
 * @default
 ...
 * @param Command Order
 * @parent ---一般---
 * @desc コマンドメニューが表示される順序です。 個々のコマンドを区切るにはスペースを使います。
 * @default Buy Sell Equip Custom Cancel
 *
 * @param Shop List Width
 * @parent ---一般---
 * @desc メインショップリストウィンドウのウィンドウ幅を計算式で調整できます。
 * @default Graphics.boxWidth / 2 + Graphics.boxWidth / 10
 *
 * @param Command Alignment
 * @parent ---一般---
 ...
 * @type number
 * @min 0
 * @desc 表示アイコンの幅と高さになります。 通常はデフォルトのアイコンの4倍です。
 * @default 128
 *
 * @param Font Size
 * @parent ---情報ウィンドウ---
 ...
 * 店舗でも詳細表示できるほか、カスタムコマンドをコマンドウィンドウに
 * 挿入することもできます。
 *
 * このプラグインは、変化量の一覧をパーティー全体のモードと
 * 個々のアクター間をタブを切り替えるモードを選ぶオプションを提供します。
 * プレイヤーは、キーボードの 'tab'ボタンを押すか、
 * アクターの名前またはパラメータをタッチ入力することで、
 * 2つのモードを切り替えることができます。
 *
 * ============================================================================
 * Instructions
 * ============================================================================
 *
 * 'Command Order'パラメータを変更することで、コマンドウィンドウにコマンドを
 * 追加したり削除したりできます。 
 ...
 *
 *   Custom
 *   - カスタムショップメニュー項目がある場合は、それらがここに表示されます。
 *
 *   Cancel
 *   - 店を出ます。
 *
 ...
 * ============================================================================
 *
 * 様々な店の様相を変えるために次のメモタグを活用してください。
 *
 * アイテム、武器、防具 のメモタグ:
 *
 *   <Price: x>
 *   このメモタグは商品価格に対するデフォルトのエディタ制限を超えることができます。
 *
 *   <Sell Price: x>
 *   商品の売却価格を x に設定します。
 *
